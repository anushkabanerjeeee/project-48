...
var ghost,ghostGroup,ghostImg,bullet,bulletImg,bulletGroup,bullets=9,heartImg1,heartImg2,heartImg3,bat,batImg
var life = 3
var score = 0
var gameState = "play"
...
function spawnBat(){
  ...
  bat.debug = true
  batGroup.add(bat)
bat.setCollider("rectangle",0,0,200,400)
 }
}
 function spawnGhost(){
  if(frameCount%60===0){
    ghost=createSprite(random(500,1100),random(300,500),40,40)
